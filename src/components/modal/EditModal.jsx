...
// export default function EditModal({ data, onDataUpdated, onClose }) {
//     const apiBase = process.env.NEXT_PUBLIC_API_URL;
//     const [isOpen, setIsOpen] = useState(true);
//     const [isLoading, setIsLoading] = useState(false);
//     const initialCount = data.length;
//     const [numStudents, setNumStudents] = useState(initialCount);
...
//                 ...data[i - 1],
//                 time: new Date(),
//                 studentName: formatName(e.target[`studentName${i}`].value),
...
//         try {
//             // 1) Send updated array to your Express PUT endpoint
...
//             // 2) Success → update parent, close, then trigger notifications
...
//                             id={`subject${i}`}
//                             className='mb-5 block py-2.5 px-0 w-full text-gray-500 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-gray-300 peer'
//                             required>
...
//                                         option.state === 'disabled' ? 'text-gray-400' : 'text-gray-700'
//                                     }`}>
//                                     {option.type}
//                                     {option.state === 'disabled' ? ' (Sắp khai giảng)' : ''}
//                                 </option>
//                             ))}
//                         </select>
//                     </div>
...
//                                     <Dialog.Title as='h1' className='text-2xl  font-bold text-gray-900 mb-4'>
