...
export default function DeleteModal({ onClose, onConfirm, isBulk, studentName }) {
                                        ...
                                        <div className='sm:flex sm:items-start'>
                                            ...
                                            <div className='mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left'>
                                                <Dialog.Title as='h3' className='font-semibold leading-6 text-gray-900'>
                                                    {isBulk
                                                        ? 'Xoá tất cả học sinh đã đăng ký'
                                                        : `Xoá thông tin của học sinh “${studentName}”`}
                                                </Dialog.Title>
                                                <div className='mt-2'>
                                                    <p className=' text-gray-500'>
                                                        {isBulk
                                                            ? 'Phụ huynh có chắc chắn muốn xoá toàn bộ học sinh đã đăng ký không? Thao tác này không thể hoàn tác.'
                                                            : `Phụ huynh có chắc chắn muốn xoá học sinh “${studentName}” không? Thao tác này không thể hoàn tác.`}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
